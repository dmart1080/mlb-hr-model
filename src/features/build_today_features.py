...
def _load_latest_train_table() -> pd.DataFrame:
    ...
    """
    candidates = [
        # Compact 90-day slice committed to git for GitHub Actions (generated by
        # scripts/export_slim_table.py after each monthly retrain).
        PROCESSED_DIR / "train_table_slim_90d.parquet",
